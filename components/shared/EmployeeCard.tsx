...
function EmployeeImage({
  ...
  if (
    ...
    return (
      <div
        className="absolute inset-0 flex items-center justify-center bg-[var(--brand-secondary)] text-[var(--brand-muted)]"
        aria-label={`${employee.name} nema fotografiju`}
      >
        <UserRound
          className="h-10 w-10"
          aria-hidden="true"
...
export default function EmployeeCard(
  ...
  if (
    ...
    return (
      ...
      >
        <div
          className="relative h-24 w-24 flex-shrink-0 overflow-hidden rounded-xl bg-[var(--brand-secondary)] sm:h-28 sm:w-28"
        >
          <EmployeeImage
            employee={
              employee
        ...
        >
          <h3
            className="font-display truncate text-lg font-semibold text-[var(--brand-text)]"
          >
            {employee.name}
          </h3>

          <div
            className="mt-0.5 text-sm font-medium text-[var(--brand-primary)]"
          >
            {t(
              employee.role,
              locale
          ...
          <p
            className="mt-2 text-sm leading-snug text-[var(--brand-muted)]"
          >
            {t(
              employee.bio,
              locale
  ...
  if (
    ...
    return (
      <article
        className="group relative overflow-hidden rounded-3xl border-2 border-[var(--brand-border)] bg-[var(--brand-surface)]"
      >
        <div
          className="relative aspect-[4/5] overflow-hidden bg-[var(--brand-secondary)]"
        >
          <EmployeeImage
            employee={
              employee
        ...
        >
          <h3
            className="font-display mb-1 text-xl font-semibold text-[var(--brand-text)]"
          >
            {employee.name}
          </h3>
          ...
          <p
            className="mb-4 text-sm leading-relaxed text-[var(--brand-muted)]"
          >
            {t(
              employee.bio,
              locale
